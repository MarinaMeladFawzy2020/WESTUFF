...
export class EditComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, private service: QuestionnaireService, private snack: MatSnackBar, private activatedRoute: ActivatedRoute, private route: Router, public datepipe: DatePipe) {
        ...
        if (data.navigationId == 1) {
          ...
          this.service.getQuestionnaireInfoById(this.questionnaireId).subscribe(
            ...
            Response => {
              ...
              //console.log('before ', this.pDate)
              let pubDate = this.datepipe.transform(this.pDate, 'yyyy-MM-dd\'T\'HH:mm');
              //console.log('after ', pubDate)
