...
@Component({
  selector: 'app-view-survey-statistics',
  templateUrl: './view-survey-statistics.component.html',
  styleUrls: ['./view-survey-statistics.component.css'],
  animations: [
...
export class ViewSurveyStatisticsComponent implements OnInit {
  ...
  constructor(private router: Router,private service:SurveyService,private activatedRoute: ActivatedRoute,private route: Router){
  ...
  displayedquestionsColumnsList: string[] = ['order', 'title', 'actions'];
