...
@Component({
  ...
  styleUrls: ['./survey-questions-modal.component.css']
})
export class SurveyQuestionsModalComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<SurveyQuestionsModalComponent>,
    @Inject(MAT_DIALOG_DATA) public data: DialogData, private service:SurveyService,private snack: MatSnackBar) {}
...
this.service.getQuestionDetailsWithAnswer(this.request).subscribe(
  ...
  this.question.surveyId=res['surveyId']
...
this.question.surveyId=this.data['surveyId']
